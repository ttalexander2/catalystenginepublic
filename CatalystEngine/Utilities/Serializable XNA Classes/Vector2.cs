...
namespace Catalyst.Engine.Utilities
{
    ...
    public struct Vector2 : IEquatable<Vector2>
    {
        ...
        public static implicit operator Microsoft.Xna.Framework.Vector2(Catalyst.Engine.Utilities.Vector2 x)
        {
            return new Microsoft.Xna.Framework.Vector2(x.X, x.Y);
        }

        public static implicit operator Catalyst.Engine.Utilities.Vector2(Microsoft.Xna.Framework.Vector2 x)
        {
            return new Catalyst.Engine.Utilities.Vector2(x.X, x.Y);
        }
    }
}