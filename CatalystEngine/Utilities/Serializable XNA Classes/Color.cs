...
namespace Catalyst.Engine.Utilities
{
    ...
    public struct Color : IEquatable<Color>
    {
        ...
        public static implicit operator Microsoft.Xna.Framework.Color(Catalyst.Engine.Utilities.Color x)
        {
            return new Microsoft.Xna.Framework.Color(x.PackedValue);
        }

        public static implicit operator Catalyst.Engine.Utilities.Color(Microsoft.Xna.Framework.Color x)
        {
            return new Catalyst.Engine.Utilities.Color(x.PackedValue);
        }
    }
}