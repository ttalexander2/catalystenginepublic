...
{
    public static class SceneWindows
    {
        public static bool HierarchyWindow = true;
        ...
        private static void RenderTree(FolderNode root)
        {
            ...
            foreach (Node n in root.Values)
            {
                ...
                else
                {
                    ...
                    if (ImGui.BeginChild("editing_name_of_thing", System.Numerics.Vector2.Zero, false, flags))
                    {
                ...
                if (!Viewport.Playing && n.Selected && !_contextOpen && ImGui.BeginPopupContextWindow())
                {
                    _contextOpen = true;
