    ...
    public static class SceneLoader
    {
        public static World LoadScene(string ContentDirectory)
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                var grass_sprite = new Sprite(grass, "grass_"+i, 16+32*i, 344+Global.Height, new Texture2D[] { Content.Load<Texture2D>(ContentDirectory + "/Sprites/Tiles/Grass/grass_top") }, Origin.Center);
