...
namespace Chroma.Engine.Utilities
{
    ...
    public struct Point : IEquatable<Point>
    {
        ...
        public static implicit operator Microsoft.Xna.Framework.Point(Chroma.Engine.Utilities.Point x)
        {
            return new Microsoft.Xna.Framework.Point(x.X, x.Y);
        }

        public static implicit operator Chroma.Engine.Utilities.Point(Microsoft.Xna.Framework.Point x)
        {
            return new Chroma.Engine.Utilities.Point(x.X, x.Y);
        }
    }
}
