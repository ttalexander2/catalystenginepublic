...
namespace Chroma.Engine.Utilities
{
    ...
    public struct Rectangle : IEquatable<Rectangle>
    {
        ...
        public static implicit operator Microsoft.Xna.Framework.Rectangle(Chroma.Engine.Utilities.Rectangle x)
        {
            return new Microsoft.Xna.Framework.Rectangle(x.X, x.Y, x.Width, x.Height);
        }

        public static implicit operator Chroma.Engine.Utilities.Rectangle(Microsoft.Xna.Framework.Rectangle x)
        {
            return new Chroma.Engine.Utilities.Rectangle(x.X, x.Y, x.Width, x.Height);
        }
    }
}