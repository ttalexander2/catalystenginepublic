...
namespace Chroma.Engine.Utilities
{
    ...
    public struct Matrix : IEquatable<Matrix>
    {
        ...
        public static implicit operator Microsoft.Xna.Framework.Matrix(Chroma.Engine.Utilities.Matrix x)
        {
        ...
        public static implicit operator Chroma.Engine.Utilities.Matrix(Microsoft.Xna.Framework.Matrix x)
        {
            Chroma.Engine.Utilities.Matrix ret = new Chroma.Engine.Utilities.Matrix(x.M11, x.M12, x.M13, x.M14, x.M21, x.M22, x.M23, x.M24, x.M31, x.M32, x.M33, x.M34, x.M41, x.M42, x.M43, x.M44);
            ret.Translation = x.Translation;
            ret.Forward = x.Forward;
            ret.Backward = x.Backward;
            ret.Up = x.Up;
