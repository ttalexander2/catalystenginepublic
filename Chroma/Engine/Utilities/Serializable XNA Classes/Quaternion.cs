...
namespace Chroma.Engine.Utilities
{
    ...
    public struct Quaternion : IEquatable<Quaternion>
    {
        ...
        public static implicit operator Microsoft.Xna.Framework.Quaternion(Chroma.Engine.Utilities.Quaternion x)
        {
            return new Microsoft.Xna.Framework.Quaternion(x.X, x.Y, x.Z, x.W);
        }

        public static implicit operator Chroma.Engine.Utilities.Quaternion(Microsoft.Xna.Framework.Quaternion x)
        {
            return new Chroma.Engine.Utilities.Quaternion(x.X, x.Y, x.Z, x.W);
        }
    }
}
