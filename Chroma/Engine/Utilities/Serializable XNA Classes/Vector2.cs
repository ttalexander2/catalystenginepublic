...
namespace Chroma.Engine.Utilities
{
    ...
    public struct Vector2 : IEquatable<Vector2>
    {
        ...
        public static implicit operator Microsoft.Xna.Framework.Vector2(Chroma.Engine.Utilities.Vector2 x)
        {
            return new Microsoft.Xna.Framework.Vector2(x.X, x.Y);
        }

        public static implicit operator Chroma.Engine.Utilities.Vector2(Microsoft.Xna.Framework.Vector2 x)
        {
            return new Chroma.Engine.Utilities.Vector2(x.X, x.Y);
        }
    }
}