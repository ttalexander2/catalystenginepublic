...
namespace Chroma.Engine.Utilities
{
    ...
    public struct Color : IEquatable<Color>
    {
        ...
        public static implicit operator Microsoft.Xna.Framework.Color(Chroma.Engine.Utilities.Color x)
        {
            return new Microsoft.Xna.Framework.Color(x.PackedValue);
        }

        public static implicit operator Chroma.Engine.Utilities.Color(Microsoft.Xna.Framework.Color x)
        {
            return new Chroma.Engine.Utilities.Color(x.PackedValue);
        }
    }
}