...
namespace Chroma.Engine.Utilities
{
    ...
    public struct Vector3 : IEquatable<Vector3>
    {
        ...
        public static implicit operator Microsoft.Xna.Framework.Vector3(Chroma.Engine.Utilities.Vector3 x)
        {
            return new Microsoft.Xna.Framework.Vector3(x.X, x.Y, x.Z);
        }

        public static implicit operator Chroma.Engine.Utilities.Vector3(Microsoft.Xna.Framework.Vector3 x)
        {
            return new Chroma.Engine.Utilities.Vector3(x.X, x.Y, x.Z);
        }
    }
}