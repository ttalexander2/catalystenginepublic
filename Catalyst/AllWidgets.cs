...
namespace Catalyst
{
	public partial class AllWidgets : Grid
	{
		public AllWidgets()
		{
			...
			_buttonOpenFile.Image = Myra.DefaultAssets.UISpritesheet["icon-star"];
			...
			_buttonSaveFile.Image = Myra.DefaultAssets.UISpritesheet["icon-star"];
			...
			_buttonChooseFolder.Image = Myra.DefaultAssets.UISpritesheet["icon-star"];
			...
			_imageButton.Image = Myra.DefaultAssets.UISpritesheet["icon-star-outline"];
			...
			{
				var messageBox = Dialog.CreateMessageBox("AllWidgets", "Myra AllWidgets Sample " + Myra.MyraEnvironment.Version);
