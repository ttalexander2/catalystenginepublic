...
namespace Catalyst.Engine.Utilities
{
    ...
    public struct Vector3 : IEquatable<Vector3>
    {
        ...
        public static implicit operator Microsoft.Xna.Framework.Vector3(Catalyst.Engine.Utilities.Vector3 x)
        {
            return new Microsoft.Xna.Framework.Vector3(x.X, x.Y, x.Z);
        }

        public static implicit operator Catalyst.Engine.Utilities.Vector3(Microsoft.Xna.Framework.Vector3 x)
        {
            return new Catalyst.Engine.Utilities.Vector3(x.X, x.Y, x.Z);
        }
    }
}