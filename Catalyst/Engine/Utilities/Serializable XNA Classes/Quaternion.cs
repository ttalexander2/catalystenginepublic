...
namespace Catalyst.Engine.Utilities
{
    ...
    public struct Quaternion : IEquatable<Quaternion>
    {
        ...
        public static implicit operator Microsoft.Xna.Framework.Quaternion(Catalyst.Engine.Utilities.Quaternion x)
        {
            return new Microsoft.Xna.Framework.Quaternion(x.X, x.Y, x.Z, x.W);
        }

        public static implicit operator Catalyst.Engine.Utilities.Quaternion(Microsoft.Xna.Framework.Quaternion x)
        {
            return new Catalyst.Engine.Utilities.Quaternion(x.X, x.Y, x.Z, x.W);
        }
    }
}
