    ...
    public struct Ray : IEquatable<Ray>
    {
        ...
        */
        ...
        public void Intersects(ref BoundingSphere sphere, out float? result)
        {
            ...
            Vector3 difference = (Catalyst.Engine.Utilities.Vector3)sphere.Center - this.Position;
        ...
        public static implicit operator Microsoft.Xna.Framework.Ray(Catalyst.Engine.Utilities.Ray x)
        {
            return new Microsoft.Xna.Framework.Ray(x.Position, x.Direction);
        }

        public static implicit operator Catalyst.Engine.Utilities.Ray(Microsoft.Xna.Framework.Ray x)
        {
            return new Catalyst.Engine.Utilities.Ray(x.Position, x.Direction);
        }
    }
}