...
namespace Catalyst.Engine.Utilities
{
    ...
    public struct Rectangle : IEquatable<Rectangle>
    {
        ...
        /// <summary>
        /// Gets whether or not the provided <see cref="Utilities.Vector2"/> lies within the bounds of this <see cref="Rectangle"/>.
        /// </summary>
        /// <param name="value">The coordinates to check for inclusion in this <see cref="Rectangle"/>.</param>
        /// <returns><c>true</c> if the provided <see cref="Utilities.Vector2"/> lies inside this <see cref="Rectangle"/>; <c>false</c> otherwise.</returns>
        public bool Contains(Utilities.Vector2 value)
        {
            return ((((this.X <= value.X) && (value.X < (this.X + this.Width))) && (this.Y <= value.Y)) && (value.Y < (this.Y + this.Height)));
        }
        ...
        /// </summary>
        /// <param name="value">The coordinates to check for inclusion in this <see cref="Rectangle"/>.</param>
        /// <param name="result"><c>true</c> if the provided <see cref="Utilities.Vector2"/> lies inside this <see cref="Rectangle"/>; <c>false</c> otherwise. As an output parameter.</param>
        public void Contains(ref Utilities.Vector2 value, out bool result)
        {
            result = ((((this.X <= value.X) && (value.X < (this.X + this.Width))) && (this.Y <= value.Y)) && (value.Y < (this.Y + this.Height)));
        }
        ...
        /// </summary>
        /// <param name="amount">The x and y components to add to this <see cref="Rectangle"/>.</param>
        public void Offset(Utilities.Vector2 amount)
        {
            X += (int)amount.X;
            Y += (int)amount.Y;
        }
        ...
        public static implicit operator Microsoft.Xna.Framework.Rectangle(Catalyst.Engine.Utilities.Rectangle x)
        {
            return new Microsoft.Xna.Framework.Rectangle(x.X, x.Y, x.Width, x.Height);
        }

        public static implicit operator Catalyst.Engine.Utilities.Rectangle(Microsoft.Xna.Framework.Rectangle x)
        {
            return new Catalyst.Engine.Utilities.Rectangle(x.X, x.Y, x.Width, x.Height);
        }
    }
}