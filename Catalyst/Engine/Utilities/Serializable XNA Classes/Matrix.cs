...
namespace Catalyst.Engine.Utilities
{
    ...
    public struct Matrix : IEquatable<Matrix>
    {
        ...
        /// <param name="zFarPlane">Depth of the far plane.</param>
        /// <returns>The new projection <see cref="Matrix"/> for customized orthographic view.</returns>
        public static Matrix CreateOrthographicOffCenter(Utilities.Rectangle viewingVolume, float zNearPlane, float zFarPlane)
        {
            Matrix matrix;
        ...
        /// <param name="farPlaneDistance">Distance to the far plane.</param>
        /// <returns>The new <see cref="Matrix"/> for customized perspective view.</returns>
        public static Matrix CreatePerspectiveOffCenter(Utilities.Rectangle viewingVolume, float nearPlaneDistance, float farPlaneDistance)
        {
            Matrix result;
        ...
        /// <param name="matrix2">The second <see cref="Utilities.Vector2"/>.</param>
        ...
        public static implicit operator Microsoft.Xna.Framework.Matrix(Catalyst.Engine.Utilities.Matrix x)
        {
            Microsoft.Xna.Framework.Matrix ret =  new Microsoft.Xna.Framework.Matrix(x.M11, x.M12, x.M13, x.M14, x.M21, x.M22, x.M23, x.M24, x.M31, x.M32, x.M33, x.M34, x.M41, x.M42, x.M43, x.M44);
            ret.Translation = x.Translation;
            ret.Forward = x.Forward;
            ret.Backward = x.Backward;
            ret.Up = x.Up;
            ret.Left = x.Left;
            ret.Right = x.Right;
            ret.Down = x.Down;
        ...
        public static implicit operator Catalyst.Engine.Utilities.Matrix(Microsoft.Xna.Framework.Matrix x)
        {
            Catalyst.Engine.Utilities.Matrix ret = new Catalyst.Engine.Utilities.Matrix(x.M11, x.M12, x.M13, x.M14, x.M21, x.M22, x.M23, x.M24, x.M31, x.M32, x.M33, x.M34, x.M41, x.M42, x.M43, x.M44);
            ret.Translation = x.Translation;
            ret.Forward = x.Forward;
            ret.Backward = x.Backward;
            ret.Up = x.Up;
