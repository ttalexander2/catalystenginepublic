...
namespace Catalyst.Engine.Utilities
{
    ...
    public struct Vector4 : IEquatable<Vector4>
    {
        ...
        public static implicit operator Microsoft.Xna.Framework.Vector4(Catalyst.Engine.Utilities.Vector4 x)
        {
            return new Microsoft.Xna.Framework.Vector4(x.X, x.Y, x.Z, x.W);
        }

        public static implicit operator Catalyst.Engine.Utilities.Vector4(Microsoft.Xna.Framework.Vector4 x)
        {
            return new Catalyst.Engine.Utilities.Vector4(x.X, x.Y, x.Z, x.W);
        }
    }
}