...
namespace Catalyst.Engine.Utilities
{
    ...
    public struct Point : IEquatable<Point>
    {
        ...
        /// <summary>
        /// Gets a <see cref="Utilities.Vector2"/> representation for this object.
        /// </summary>
        /// <returns>A <see cref="Utilities.Vector2"/> representation for this object.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Utilities.Vector2 ToVector2()
        {
            return new Utilities.Vector2(X, Y);
        }
        ...
        public static implicit operator Microsoft.Xna.Framework.Point(Catalyst.Engine.Utilities.Point x)
        {
            return new Microsoft.Xna.Framework.Point(x.X, x.Y);
        }

        public static implicit operator Catalyst.Engine.Utilities.Point(Microsoft.Xna.Framework.Point x)
        {
            return new Catalyst.Engine.Utilities.Point(x.X, x.Y);
        }
    }
}
